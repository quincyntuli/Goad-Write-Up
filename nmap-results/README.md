...
- notable port numbers : 53,80,88,389,445

### north.sevenkingdoms.local
- host : winterfell.north.sevenkingdoms.local (192.168.56.11) - DC
- notable port numbers : 53,88,389,445
  
- host : north.sevenkingdoms.local (192.168.56.22 )
- notable port numbers : 80,445,1433
...
```ruby
grep "Ports:" nmap-services-192.168.56.10.gnmap | sed 's/.*Ports: //' | tr ',' '\n' | cut -d '/' -f 1 | sort -n
```

```ruby
xsltproc nmap-services-192.168.56.10.xml -o map-services-192.168.56.10.html
```
